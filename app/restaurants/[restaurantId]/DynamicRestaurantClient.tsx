...
export default function DynamicRestaurantClient({ restaurantId: restaurantIdProp }: { restaurantId: string }) {
  ...
  if (restaurants.length > 0 && !restaurant) {
    return <main dir="rtl" className="missing"><h1>المطعم غير موجود</h1><Link href="/restaurants">العودة للمطاعم</Link><style jsx>{`.missing{min-height:100vh;display:grid;place-content:center;gap:16px;text-align:center;font-family:var(--fuse-body-font);background:#f4efe6}.missing a{color:#1f7a4f;font-weight:900}`}</style></main>;
  }
  ...
  return (
    <main dir="rtl" className="page restaurant-detail-page dynamic-restaurant-page">
      ...
      <style jsx>{`
        *{box-sizing:border-box}.page{min-height:100dvh;background:transparent;color:#15171a;font-family:var(--fuse-body-font);padding:0}.phone{width:min(100%,430px);min-height:100dvh;margin:auto;background:transparent;padding:0}header{display:grid;grid-template-columns:48px 1fr auto;gap:12px;align-items:center;margin-bottom:14px;padding:8px 10px;border-radius:28px;background:rgba(255,252,247,.82);border:1px solid rgba(255,255,255,.95);box-shadow:0 10px 28px rgba(21,23,26,.08);backdrop-filter:blur(22px)}header div{display:grid;text-align:center}header small{color:#1f7a4f;font-weight:900;font-size:10px}header b{font-size:16px;color:#15171a}.back,.cart{height:46px;text-decoration:none;font-weight:900}.back{width:46px;border-radius:50%;display:grid;place-items:center;background:rgba(255,252,247,.9);border:1px solid rgba(21,23,26,.08);color:#1f7a4f;box-shadow:0 8px 22px rgba(21,23,26,.06)}.cart{padding:0 12px;border-radius:18px;display:grid;place-items:center;background:linear-gradient(135deg,#1f7a4f,#2f915f);color:#fff;font-size:12px;box-shadow:0 10px 24px rgba(31,122,79,.2)}.state-card{margin:0 0 12px;padding:14px 16px;border-radius:18px;background:rgba(255,252,247,.88);color:#7b5700;font-size:12px;font-weight:900;line-height:1.7;border:1px solid rgba(21,23,26,.06);text-align:center}.hero{min-height:250px;border-radius:28px;background:linear-gradient(135deg,#1a2235,#263759);background-size:cover;background-position:center;color:#fff;padding:22px;display:flex;flex-direction:column;justify-content:space-between;box-shadow:0 16px 42px rgba(26,34,53,.16)}.emoji{font-size:44px}.hero p{margin:4px 0;color:rgba(255,255,255,.78);line-height:1.7;font-weight:700}.hero h1{font-size:34px;margin:4px 0}.info{display:grid;grid-template-columns:repeat(2,1fr);gap:9px;margin:12px 0}.info div{background:rgba(255,252,247,.86);border-radius:18px;padding:12px;display:grid;gap:5px;border:1px solid rgba(255,255,255,.92);backdrop-filter:blur(18px)}.info span{font-size:11px;color:#888;font-weight:800}.info b{font-size:13px}.rating-row{display:inline-flex;align-items:center;gap:4px;color:#1f7a4f}.green{color:#1f7a4f}.red{color:#d63b3b}.title{display:flex;justify-content:space-between;align-items:end;margin:20px 2px 10px}.title small{color:#1f7a4f;font-weight:900}.title h2{margin:2px 0 0;font-size:25px}.title span{font-size:12px;color:#777;font-weight:800}.menu{display:grid;gap:10px}.menu article{display:grid;grid-template-columns:82px 1fr 46px;gap:12px;align-items:center;background:rgba(255,252,247,.86);border-radius:22px;padding:10px;border:1px solid rgba(255,255,255,.92);box-shadow:0 10px 28px rgba(21,23,26,.07);backdrop-filter:blur(18px)}.item-image{width:82px;height:82px;border-radius:50%;background:rgba(255,255,255,.72);overflow:hidden;display:grid;place-items:center;color:#1f7a4f;border:1px solid rgba(21,23,26,.06)}.item-image img{width:100%;height:100%;object-fit:cover}.copy{display:grid;gap:4px}.copy small{color:#1f7a4f;font-weight:900}.copy h3{margin:0;font-size:17px}.copy b{font-size:14px;color:#15171a}.add-btn{width:46px;height:46px;border:0;border-radius:50%;background:linear-gradient(135deg,#1f7a4f,#2f915f);color:#fff;display:grid;place-items:center;box-shadow:0 10px 24px rgba(31,122,79,.2)}.add-btn:disabled{background:#bbb;box-shadow:none;color:#fff}.empty,.contact{background:rgba(255,252,247,.86);border-radius:22px;padding:20px;text-align:center;border:1px solid rgba(21,23,26,.06)}.empty h3{margin:0}.empty p,.contact p{color:#777}.contact{margin-top:12px}.contact a{color:#1f7a4f;font-weight:900}.toast{position:fixed;bottom:calc(96px + env(safe-area-inset-bottom));left:50%;transform:translateX(-50%);background:#15171a;color:#fff;padding:13px 20px;border-radius:999px;font-weight:900;z-index:20}@media(max-width:520px){.page{padding-inline:14px}}
      `}</style>
    </main>
  );
}
