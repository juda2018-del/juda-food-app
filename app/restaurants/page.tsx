...
export default function RestaurantsPage() {
  ...
  return (
    <main dir="rtl" className="page">
      ...
      <style jsx>{`
        *{box-sizing:border-box}.page{min-height:100dvh;display:grid;place-items:start center;background:#efe8df;font-family:var(--fuse-body-font);color:#151515}.phone{width:min(100%,430px);min-height:100dvh;background:linear-gradient(180deg,#fffaf4,#fff);padding:calc(14px + env(safe-area-inset-top)) 16px 104px}.top{display:grid;grid-template-columns:48px 1fr 48px;align-items:center;gap:10px;margin-bottom:14px}.top>div{text-align:center}.top p{margin:0;color:#ff4d00;font-weight:900;font-size:12px}.top h1{margin:2px 0 0;font-size:28px;font-weight:950}.back,.cart{height:44px;border-radius:15px;background:white;color:#151515;text-decoration:none;display:grid;place-items:center;font-weight:950;box-shadow:0 8px 22px rgba(0,0,0,.07)}.back{font-size:28px}.cart{color:#ff4d00;font-size:12px}.hero{border-radius:26px;padding:20px;background:linear-gradient(135deg,#151515,#2a2a2a);color:white;margin-bottom:14px;box-shadow:0 14px 36px rgba(0,0,0,.14)}.hero span{color:#ff8a00;font-weight:950}.hero h2{margin:8px 0;font-size:24px;font-weight:950;line-height:1.3}.hero p{margin:0;color:rgba(255,255,255,.75);line-height:1.75;font-size:13px;font-weight:700}.warning{margin:0 0 12px;padding:12px 14px;border-radius:16px;background:#fff4d8;color:#7b5700;font-size:12px;font-weight:900;line-height:1.7}.search{margin-bottom:12px}.search input{width:100%;border:1px solid #eee4db;outline:0;border-radius:17px;background:#fff;padding:14px 16px;font:inherit;box-shadow:0 8px 22px rgba(0,0,0,.05)}.grid{display:grid;gap:12px}.card{display:grid;grid-template-columns:82px minmax(0,1fr);gap:13px;align-items:center;text-decoration:none;color:#151515;background:white;border-radius:24px;padding:12px;box-shadow:0 10px 28px rgba(0,0,0,.07);position:relative}.icon{width:82px;height:82px;border-radius:20px;background:#fff3e9;display:grid;place-items:center;font-size:30px;overflow:hidden}.icon img{width:100%;height:100%;object-fit:cover}.name-row{display:flex;gap:8px;align-items:center;justify-content:space-between}.card h3{margin:0;font-size:18px;font-weight:950}.name-row span{font-size:10px;font-weight:900;border-radius:999px;padding:5px 8px;white-space:nowrap}.open{background:#e2f7e8;color:#148b3c}.closed{background:#ffe4e4;color:#c53737}.card p{margin:5px 0;color:#6f6a65;font-size:12px;line-height:1.55;font-weight:700}.card small{color:#8b847e;font-size:11px;font-weight:800}.card>b{display:none}.empty,.loading{background:#fff;border-radius:20px;padding:16px;text-align:center;color:#777;font-weight:900}.loading{padding:10px;font-size:12px}
      `}</style>
    </main>
  );
}
