  ...
  return (
    <main dir="rtl" className="page reels-page">
      ...
      <style jsx>{`
        ...
        .toast{position:fixed;z-index:50;left:50%;bottom:96px;transform:translateX(-50%);background:rgba(255,252,247,.92);color:#15171a;padding:12px 18px;border-radius:999px;font-weight:900;white-space:nowrap;border:1px solid rgba(255,255,255,.92);backdrop-filter:blur(18px)}
