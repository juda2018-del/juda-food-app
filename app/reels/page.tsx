...
const fallbackReels: ReelDoc[] = [
  { documentId: "fuse-reel-fayrouz-1", title: "فطور عراقي يفتح النفس", caption: "كاهي وقيمر وشاي عراقي... مذاق بغداد من فيروز.", restaurant: "فيروز", restaurantSlug: "fayrouz", category: "فطور", offer: "خصم 20%", menuItem: "كاهي وقيمر", price: 4500, deliveryTime: "20-30 دقيقة", videoUrl: "/videos/reel-1.mp4", image: "/images/m6.jpg", sourceUrl: "https://youtube.com/shorts/Qqfbt9NsxOg?si=BLlq_6YDOwCVWco5", likes: 1800, views: 14200 },
  { documentId: "fuse-reel-shalteta-1", title: "مشلتت جبن يسحب", caption: "طازج، حار، وجبن يذوب من أول لقمة.", restaurant: "شلتتة", restaurantSlug: "shalteta", category: "فطور", offer: "توصيل سريع", menuItem: "مشلتت جبن", price: 7500, deliveryTime: "25-35 دقيقة", videoUrl: "/videos/reel-2.mp4", image: "/images/m3.jpg", sourceUrl: "https://youtube.com/shorts/U7_6LOtam1g?si=wgw08D8gGYivBMZe", likes: 1290, views: 9800 },
  { documentId: "fuse-reel-khan-1", title: "وجبة عراقية من خان قدوري", caption: "رز ومرگ ودجاج مشوي... غداء عراقي كامل.", restaurant: "خان قدوري", restaurantSlug: "khan", category: "مشاوي", offer: "وجبات يومية", menuItem: "دجاج مشوي", price: 9000, deliveryTime: "30-40 دقيقة", videoUrl: "/videos/reel-3.mp4", image: "/images/khan.jpg", sourceUrl: "https://youtube.com/shorts/cToLyOXKL8s?si=I1bFwfYihFObgkE6", likes: 2140, views: 18300 },
  { documentId: "fuse-reel-alforn-1", title: "مناقيش الفرن", caption: "مناقيش ومعجنات حارة بطعم يوصلك للفرن مباشرة.", restaurant: "الفرن", restaurantSlug: "alforn", category: "بيتزا", offer: "جديد", menuItem: "مناقيش جبن", price: 6000, deliveryTime: "25-35 دقيقة", videoUrl: "/videos/reel-4.mp4", image: "/images/m5.jpg", likes: 870, views: 7200 },
];
  ...
  return (
    <main dir="rtl" className="page reels-page">
      ...
      <style jsx>{`
        ...
        .content{position:absolute;z-index:5;right:14px;left:70px;bottom:16px;text-shadow:0 2px 10px rgba(0,0,0,.85)}.restaurant-line{display:flex;align-items:center;gap:7px;margin-bottom:7px}.restaurant-line b{font-size:15px}.restaurant-line em{width:17px;height:17px;display:grid;place-items:center;border-radius:50%;background:#54b9ff;font-size:11px;font-style:normal}.restaurant-line strong{font-size:10px;padding:5px 8px;border-radius:999px;background:#ff5964}h1{margin:0 0 6px;font-size:22px}p{margin:0 0 9px;font-size:13px;line-height:1.6;color:rgba(255,255,255,.88);display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.stats{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:7px}.stats span{font-size:9px;padding:5px 8px;border-radius:999px;background:rgba(0,0,0,.45);border:1px solid rgba(255,255,255,.12)}.source-link{display:inline-block;margin-bottom:9px;color:#fff;font-size:10px;font-weight:900;text-decoration:underline;text-underline-offset:3px}
