  ...
  return (
    <main dir="rtl" className="app">
      ...
      <style jsx>{`
        ...
        .top{display:grid;grid-template-columns:48px 1fr 48px;align-items:center;gap:8px;margin-bottom:18px}.back,.support{height:44px;border:0;border-radius:15px;background:#fff;color:#171717;display:grid;place-items:center;text-decoration:none;box-shadow:0 8px 24px rgba(0,0,0,.08);font-family:inherit;font-weight:900}.back{font-size:30px}.support{font-size:12px;color:#f45100}.title{text-align:center}.title h1{margin:0;font-size:27px}.title p{margin:3px 0 0;color:#777;font-size:11px;font-weight:800}
        .empty,.group,.summary,.form,.notice{background:#fff;border-radius:25px;padding:17px;margin-bottom:13px;box-shadow:0 12px 30px rgba(0,0,0,.07)}.empty{text-align:center;padding:30px 18px}.empty>div{font-size:42px}.empty h2{margin:8px 0}.empty p,.notice p{color:#777}.empty a,.notice a{display:block;padding:14px;border-radius:17px;background:#f45100;color:#fff;text-align:center;text-decoration:none;font-weight:900}.notice{text-align:center;background:#fff3e8}
