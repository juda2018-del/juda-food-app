  ...
  return (
    <main dir="rtl" className="app">
      ...
      <style jsx>{`
        ...
        .app{width:100%;max-width:430px;min-height:100dvh;margin:auto;padding:calc(14px + env(safe-area-inset-top)) 16px calc(104px + env(safe-area-inset-bottom));background:transparent;color:#15171a;font-family:var(--fuse-body-font)}
