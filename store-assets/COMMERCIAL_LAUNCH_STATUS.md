...
|------|--------|----------|
| MAIN SHA | `8069c430eaacce7718590ea9a249f60bd33638f2` (at verification start) | `git rev-parse` / GitHub |
| PRODUCTION SHA | same as main (`8069c43`) | GitHub Deployments `Production – fuse-iraq` + `juda-food-app` |
